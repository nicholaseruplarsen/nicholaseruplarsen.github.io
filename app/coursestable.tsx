      ...
      <table className={styles.table}>
        <thead>
          <tr>
            ...
            <th className={styles.tableHeader}>ECTS</th>
          </tr>
        </thead>
        <tbody>
            ...
            <React.Fragment key={index}>
              ...
              {term.courses.map((course, courseIndex) => (
                <tr key={courseIndex}>
                  ...
                  <td className={styles.tableData}>{course.result}</td>
                  <td className={styles.tableData}><a className={styles.animation} href={course.link} target="_blank" rel="noopener noreferrer">{course.avg}</a></td>
                  <td className={styles.tableData}>{course.ects}</td>
                </tr>
              ))}
            </React.Fragment>
          ))}
